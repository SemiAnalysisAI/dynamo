...
"""Fail-closed artifact verification for the trusted Slurm controller."""
...
from slurm_common import atomic_json, read_json, sha256_file, sha256_json
...
def workload(request, runtime_dir, job_id=None):
    ...
    hip = evidence["hip"]
    require(
        str(hip.get("architecture", "")).split(":")[0] == "gfx942",
